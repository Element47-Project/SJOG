...
def start_ui(df, file_path, sheet_name, max_words):
    ...
    # --------------------- 关键状态变量 ---------------------
    vocab_list = []  # 当前这一批的单词列表
    rounds_completed = 0  # 当前已完成的轮次
    words_shown = 0  # 当前轮已点击【下一个】的次数
    current_index = 0  # 当前在 vocab_list 的索引
