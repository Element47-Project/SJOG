    ...
    with fitz.open(pdf_path) as doc:
        ...
        info = {
            ...
            "BILLING PERIOD END DATE": pd.to_datetime(get_text_by_position(blocks, 122.4, 321.5).splitlines()[1],
                                                      errors="coerce"),
            "BILLING PERIOD NUMBER OF DAYS": get_text_by_position(blocks, 122.4, 321.5).splitlines()[2],
            "TOTAL GAS CONSUMPTION (GJ)": get_text_by_position(blocks, 194.8, 29.5).splitlines()[3],
