...
def calculate_additional_columns(meter_date_df):
    ...
    meter_date_df.loc[meter_date_df['Meter'] == 'RMT-APL-01-MSB-MSB-01-40002624-DL1', 'FinalReading'] += 100000
    ...
    meter_date_df['FinalTimestamp'] = meter_date_df['FinalTimestamp'].dt.strftime('%d/%m/%Y %H:%M')
...
def calculate_variance(meter_date_df, aggregated_df):
    ...
    variance_data = []
    check_meter_value = (meter_date_df.loc[meter_date_df['Meter'] == "RMT-APL-01-MSB-MSB-01-40002624-DL1", 'Consumption']
                         .sum())
    print(check_meter_value)
    calculated_value = (
        meter_date_df.loc[meter_date_df['Meter'] == "RMT-APL-01-MSB-MDB1-01-75000025-DL1", 'Consumption'].sum() +
        meter_date_df.loc[meter_date_df['Meter'] == "RMT-APL-01-MDB2-3-MDB2-3-01-75000043-DL1", 'Consumption'].sum() +
        meter_date_df.loc[meter_date_df['Meter'] == "RMT-APL-01-MDB4-5-MDB4-5-01-75000038-DL1", 'Consumption'].sum() +
...
# Modify the save function to save in Excel format
