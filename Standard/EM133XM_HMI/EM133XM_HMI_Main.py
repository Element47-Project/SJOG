...
class Page1(Page):
    def __init__(self, *args, **kwargs):
        ...
        # Display frame
        self.P1_DspFrame = tk.Frame(self, height=PAGE_FRAME_HEIGHT, width=PAGE_FRAME_WIDTH, borderwidth=2,
                                    bg="dark grey")
        self.P1_DspFrame.pack(side="top", fill="both", expand=False)

        # Page title frame
        self.P1_Title_Frame = tk.Frame(self.P1_DspFrame, height=PAGE_HEADER_HEIGHT, bd=1, relief='solid',
                                       bg=PAGE_HEADIING_COLOUR)
        self.P1_Title_Frame.pack(side="top", fill="both", expand=False)
        self.P1_Title_Frame.pack_propagate(0)

        self.P1_Title = tk.Label(self.P1_Title_Frame, text="BILLING INFORMATION", justify="right", font=30,
                                 bg=PAGE_HEADIING_COLOUR)
        ...
        self.P1_L2_Header1_Frame = tk.Frame(self.P1_Table_Container_Header_Frame,
                                            height=(self.P1_Table_Header_Height / 2),
        ...
        self.P1_L2_Header2_Frame = tk.Frame(self.P1_Table_Container_Header_Frame,
                                            height=(self.P1_Table_Header_Height / 2),
                                            width=self.P1_Table_B2_Col_Width, bd=1, relief='solid')
        ...
        self.P1_L2_Header3_Frame = tk.Frame(self.P1_Table_Container_Header_Frame,
                                            height=(self.P1_Table_Header_Height / 2),
                                            width=self.P1_Table_B2_Col_Width, bd=1, relief='solid')
        ...
        self.P1_L2_Header4_Frame = tk.Frame(self.P1_Table_Container_Header_Frame,
                                            height=(self.P1_Table_Header_Height / 2),
                                            width=self.P1_Table_B2_Col_Width, bd=1, relief='solid')
        ...
        self.P1_Current_Month_Label = tk.Label(self.P1_Current_Month, text="CURRENT MONTH", justify="center",
                                               bg=PAGE_H1_COLOUR)
        ...
        self.P1_Cur_Mon_Container_Title_Frame.pack(side="left", anchor="nw", expand=False,
                                                   padx=(self.P1_Table_B1_Col_Padx, 0))
        ...
        self.P1_3PT_Cur_Mon_Data1 = tk.Label(self.P1_3PT_Cur_Mon_Data_Frame, text="{: >4d}".format(0) + " kWh",
                                             justify="left", bd=-2)
        self.P1_3PT_Cur_Mon_Data1.pack(side="top", anchor="w", expand=False)
        self.P1_3PT_Cur_Mon_Data2 = tk.Label(self.P1_3PT_Cur_Mon_Data_Frame, text="{: >4d}".format(0) + " kWh",
                                             justify="left", bd=-2)
        self.P1_3PT_Cur_Mon_Data2.pack(side="top", anchor="w", expand=False)
        self.P1_3PT_Cur_Mon_Data3 = tk.Label(self.P1_3PT_Cur_Mon_Data_Frame, text="{: >4d}".format(0) + " kWh",
                                             justify="left", bd=-2)
        self.P1_3PT_Cur_Mon_Data3.pack(side="top", anchor="w", expand=False)
        self.P1_3PT_Cur_Mon_Data4 = tk.Label(self.P1_3PT_Cur_Mon_Data_Frame, text="{: >4d}".format(0) + " kW",
                                             justify="left", bd=-2)
        self.P1_3PT_Cur_Mon_Data4.pack(side="top", anchor="w", expand=False)
        self.P1_3PT_Cur_Mon_Data5 = tk.Label(self.P1_3PT_Cur_Mon_Data_Frame, text="{: >4d}".format(0) + " kVA",
                                             justify="left", bd=-2)
        self.P1_3PT_Cur_Mon_Data5.pack(side="top", anchor="w", expand=False)
        self.P1_3PT_Cur_Mon_Data6 = tk.Label(self.P1_3PT_Cur_Mon_Data_Frame, text="{: >4d}".format(0) + " kWh",
                                             justify="left", bd=-2)
        self.P1_3PT_Cur_Mon_Data6.pack(side="top", anchor="w", expand=False)

        # Line1 current month data
        self.P1_L1_Cur_Mon_Data_Frame = tk.Frame(self.P1_Data_Col2_Row1, height=self.P1_Table_Data_Row_Height,
                                                 width=int(200 - 120))
        self.P1_L1_Cur_Mon_Data_Frame.pack(side="top", anchor="n", expand=True)
        self.P1_L1_Cur_Mon_Data_Frame.pack_propagate(0)
        self.P1_L1_Cur_Mon_Data1 = tk.Label(self.P1_L1_Cur_Mon_Data_Frame, text="{: >4d}".format(0) + " kWh",
                                            justify="left", bd=-2)
        self.P1_L1_Cur_Mon_Data1.pack(side="top", anchor="w", expand=False)
        self.P1_L1_Cur_Mon_Data2 = tk.Label(self.P1_L1_Cur_Mon_Data_Frame, text="{: >4d}".format(0) + " kWh",
                                            justify="left", bd=-2)
        self.P1_L1_Cur_Mon_Data2.pack(side="top", anchor="w", expand=False)
        self.P1_L1_Cur_Mon_Data3 = tk.Label(self.P1_L1_Cur_Mon_Data_Frame, text="{: >4d}".format(0) + " kWh",
                                            justify="left", bd=-2)
        self.P1_L1_Cur_Mon_Data3.pack(side="top", anchor="w", expand=False)
        self.P1_L1_Cur_Mon_Data4 = tk.Label(self.P1_L1_Cur_Mon_Data_Frame, text="{: >4d}".format(0) + " kW",
                                            justify="left", bd=-2)
        self.P1_L1_Cur_Mon_Data4.pack(side="top", anchor="w", expand=False)
        self.P1_L1_Cur_Mon_Data5 = tk.Label(self.P1_L1_Cur_Mon_Data_Frame, text="{: >4d}".format(0) + " kVA",
                                            justify="left", bd=-2)
        self.P1_L1_Cur_Mon_Data5.pack(side="top", anchor="w", expand=False)
        self.P1_L1_Cur_Mon_Data6 = tk.Label(self.P1_L1_Cur_Mon_Data_Frame, text="{: >4d}".format(0) + " kWh",
                                            justify="left", bd=-2)
        self.P1_L1_Cur_Mon_Data6.pack(side="top", anchor="w", expand=False)

        # Line2 current month data
        self.P1_L2_Cur_Mon_Data_Frame = tk.Frame(self.P1_Data_Col3_Row1, height=self.P1_Table_Data_Row_Height,
                                                 width=int(200 - 120))
        self.P1_L2_Cur_Mon_Data_Frame.pack(side="top", anchor="n", expand=True)
        self.P1_L2_Cur_Mon_Data_Frame.pack_propagate(0)
        self.P1_L2_Cur_Mon_Data1 = tk.Label(self.P1_L2_Cur_Mon_Data_Frame, text="{: >4d}".format(0) + " kWh",
                                            justify="left", bd=-2)
        self.P1_L2_Cur_Mon_Data1.pack(side="top", anchor="w", expand=False)
        self.P1_L2_Cur_Mon_Data2 = tk.Label(self.P1_L2_Cur_Mon_Data_Frame, text="{: >4d}".format(0) + " kWh",
                                            justify="left", bd=-2)
        self.P1_L2_Cur_Mon_Data2.pack(side="top", anchor="w", expand=False)
        self.P1_L2_Cur_Mon_Data3 = tk.Label(self.P1_L2_Cur_Mon_Data_Frame, text="{: >4d}".format(0) + " kWh",
                                            justify="left", bd=-2)
        self.P1_L2_Cur_Mon_Data3.pack(side="top", anchor="w", expand=False)
        self.P1_L2_Cur_Mon_Data4 = tk.Label(self.P1_L2_Cur_Mon_Data_Frame, text="{: >4d}".format(0) + " kW",
                                            justify="left", bd=-2)
        self.P1_L2_Cur_Mon_Data4.pack(side="top", anchor="w", expand=False)
        self.P1_L2_Cur_Mon_Data5 = tk.Label(self.P1_L2_Cur_Mon_Data_Frame, text="{: >4d}".format(0) + " kVA",
                                            justify="left", bd=-2)
        self.P1_L2_Cur_Mon_Data5.pack(side="top", anchor="w", expand=False)
        self.P1_L2_Cur_Mon_Data6 = tk.Label(self.P1_L2_Cur_Mon_Data_Frame, text="{: >4d}".format(0) + " kWh",
                                            justify="left", bd=-2)
        self.P1_L2_Cur_Mon_Data6.pack(side="top", anchor="w", expand=False)

        # Line3 current month data
        self.P1_L3_Cur_Mon_Data_Frame = tk.Frame(self.P1_Data_Col4_Row1, height=self.P1_Table_Data_Row_Height,
                                                 width=int(200 - 120))
        self.P1_L3_Cur_Mon_Data_Frame.pack(side="top", anchor="n", expand=True)
        self.P1_L3_Cur_Mon_Data_Frame.pack_propagate(0)
        self.P1_L3_Cur_Mon_Data1 = tk.Label(self.P1_L3_Cur_Mon_Data_Frame, text="{: >4d}".format(0) + " kWh",
                                            justify="left", bd=-2)
        self.P1_L3_Cur_Mon_Data1.pack(side="top", anchor="w", expand=False)
        self.P1_L3_Cur_Mon_Data2 = tk.Label(self.P1_L3_Cur_Mon_Data_Frame, text="{: >4d}".format(0) + " kWh",
                                            justify="left", bd=-2)
        self.P1_L3_Cur_Mon_Data2.pack(side="top", anchor="w", expand=False)
        self.P1_L3_Cur_Mon_Data3 = tk.Label(self.P1_L3_Cur_Mon_Data_Frame, text="{: >4d}".format(0) + " kWh",
                                            justify="left", bd=-2)
        self.P1_L3_Cur_Mon_Data3.pack(side="top", anchor="w", expand=False)
        self.P1_L3_Cur_Mon_Data4 = tk.Label(self.P1_L3_Cur_Mon_Data_Frame, text="{: >4d}".format(0) + " kW",
                                            justify="left", bd=-2)
        self.P1_L3_Cur_Mon_Data4.pack(side="top", anchor="w", expand=False)
        self.P1_L3_Cur_Mon_Data5 = tk.Label(self.P1_L3_Cur_Mon_Data_Frame, text="{: >4d}".format(0) + " kVA",
                                            justify="left", bd=-2)
        self.P1_L3_Cur_Mon_Data5.pack(side="top", anchor="w", expand=False)
        self.P1_L3_Cur_Mon_Data6 = tk.Label(self.P1_L3_Cur_Mon_Data_Frame, text="{: >4d}".format(0) + " kWh",
                                            justify="left", bd=-2)
        ...
        self.P1_Previous_Month_Title = tk.Label(self.P1_Previous_Month, text="PREVIOUS MONTH", justify="center",
                                                bg=PAGE_H1_COLOUR)
        ...
        self.P1_Pre_Mon_Container_Title_Frame.pack(side="left", anchor="nw", expand=False,
                                                   padx=(self.P1_Table_B1_Col_Padx, 0))
        ...
        self.P1_3PT_Pre_Mon_Data_Frane = tk.Frame(self.P1_Data_Col1_Row2, height=self.P1_Table_Data_Row_Height,
                                                  width=int(200 - 120))
        self.P1_3PT_Pre_Mon_Data_Frane.pack(side="top", anchor="n", expand=True)
        self.P1_3PT_Pre_Mon_Data_Frane.pack_propagate(0)
        self.P1_3PT_Pre_Mon_Data1 = tk.Label(self.P1_3PT_Pre_Mon_Data_Frane, text="{: >4d}".format(0) + " kWh",
                                             justify="left", bd=-2)
        self.P1_3PT_Pre_Mon_Data1.pack(side="top", anchor="w", expand=False)
        self.P1_3PT_Pre_Mon_Data2 = tk.Label(self.P1_3PT_Pre_Mon_Data_Frane, text="{: >4d}".format(0) + " kWh",
                                             justify="left", bd=-2)
        self.P1_3PT_Pre_Mon_Data2.pack(side="top", anchor="w", expand=False)
        self.P1_3PT_Pre_Mon_Data3 = tk.Label(self.P1_3PT_Pre_Mon_Data_Frane, text="{: >4d}".format(0) + " kWh",
                                             justify="left", bd=-2)
        self.P1_3PT_Pre_Mon_Data3.pack(side="top", anchor="w", expand=False)
        self.P1_3PT_Pre_Mon_Data4 = tk.Label(self.P1_3PT_Pre_Mon_Data_Frane, text="{: >4d}".format(0) + " kW",
                                             justify="left", bd=-2)
        self.P1_3PT_Pre_Mon_Data4.pack(side="top", anchor="w", expand=False)
        self.P1_3PT_Pre_Mon_Data5 = tk.Label(self.P1_3PT_Pre_Mon_Data_Frane, text="{: >4d}".format(0) + " kVA",
                                             justify="left", bd=-2)
        self.P1_3PT_Pre_Mon_Data5.pack(side="top", anchor="w", expand=False)
        self.P1_3PT_Pre_Mon_Data6 = tk.Label(self.P1_3PT_Pre_Mon_Data_Frane, text="{: >4d}".format(0) + " kWh",
                                             justify="left", bd=-2)
        self.P1_3PT_Pre_Mon_Data6.pack(side="top", anchor="w", expand=False)

        # Line1 previous month data
        self.P1_L1_Pre_Mon_Data_Frame = tk.Frame(self.P1_Data_Col2_Row2, height=self.P1_Table_Data_Row_Height,
                                                 width=int(200 - 120))
        self.P1_L1_Pre_Mon_Data_Frame.pack(side="top", anchor="n", expand=True)
        self.P1_L1_Pre_Mon_Data_Frame.pack_propagate(0)
        self.P1_L1_Pre_Mon_Data1 = tk.Label(self.P1_L1_Pre_Mon_Data_Frame, text="{: >4d}".format(0) + " kWh",
                                            justify="left", bd=-2)
        self.P1_L1_Pre_Mon_Data1.pack(side="top", anchor="w", expand=False)
        self.P1_L1_Pre_Mon_Data2 = tk.Label(self.P1_L1_Pre_Mon_Data_Frame, text="{: >4d}".format(0) + " kWh",
                                            justify="left", bd=-2)
        self.P1_L1_Pre_Mon_Data2.pack(side="top", anchor="w", expand=False)
        self.P1_L1_Pre_Mon_Data3 = tk.Label(self.P1_L1_Pre_Mon_Data_Frame, text="{: >4d}".format(0) + " kWh",
                                            justify="left", bd=-2)
        self.P1_L1_Pre_Mon_Data3.pack(side="top", anchor="w", expand=False)
        self.P1_L1_Pre_Mon_Data4 = tk.Label(self.P1_L1_Pre_Mon_Data_Frame, text="{: >4d}".format(0) + " kW",
                                            justify="left", bd=-2)
        self.P1_L1_Pre_Mon_Data4.pack(side="top", anchor="w", expand=False)
        self.P1_L1_Pre_Mon_Data5 = tk.Label(self.P1_L1_Pre_Mon_Data_Frame, text="{: >4d}".format(0) + " kVA",
                                            justify="left", bd=-2)
        self.P1_L1_Pre_Mon_Data5.pack(side="top", anchor="w", expand=False)
        self.P1_L1_Pre_Mon_Data6 = tk.Label(self.P1_L1_Pre_Mon_Data_Frame, text="{: >4d}".format(0) + " kWh",
                                            justify="left", bd=-2)
        self.P1_L1_Pre_Mon_Data6.pack(side="top", anchor="w", expand=False)

        # Line2 previous month data
        self.P1_L2_Pre_Mon_Data_Frame = tk.Frame(self.P1_Data_Col3_Row2, height=self.P1_Table_Data_Row_Height,
                                                 width=int(200 - 120))
        self.P1_L2_Pre_Mon_Data_Frame.pack(side="top", anchor="n", expand=True)
        self.P1_L2_Pre_Mon_Data_Frame.pack_propagate(0)
        self.P1_L2_Pre_Mon_Data1 = tk.Label(self.P1_L2_Pre_Mon_Data_Frame, text="{: >4d}".format(0) + " kWh",
                                            justify="left", bd=-2)
        self.P1_L2_Pre_Mon_Data1.pack(side="top", anchor="w", expand=False)
        self.P1_L2_Pre_Mon_Data2 = tk.Label(self.P1_L2_Pre_Mon_Data_Frame, text="{: >4d}".format(0) + " kWh",
                                            justify="left", bd=-2)
        self.P1_L2_Pre_Mon_Data2.pack(side="top", anchor="w", expand=False)
        self.P1_L2_Pre_Mon_Data3 = tk.Label(self.P1_L2_Pre_Mon_Data_Frame, text="{: >4d}".format(0) + " kWh",
                                            justify="left", bd=-2)
        self.P1_L2_Pre_Mon_Data3.pack(side="top", anchor="w", expand=False)
        self.P1_L2_Pre_Mon_Data4 = tk.Label(self.P1_L2_Pre_Mon_Data_Frame, text="{: >4d}".format(0) + " kW",
                                            justify="left", bd=-2)
        self.P1_L2_Pre_Mon_Data4.pack(side="top", anchor="w", expand=False)
        self.P1_L2_Pre_Mon_Data5 = tk.Label(self.P1_L2_Pre_Mon_Data_Frame, text="{: >4d}".format(0) + " kVA",
                                            justify="left", bd=-2)
        self.P1_L2_Pre_Mon_Data5.pack(side="top", anchor="w", expand=False)
        self.P1_L2_Pre_Mon_Data6 = tk.Label(self.P1_L2_Pre_Mon_Data_Frame, text="{: >4d}".format(0) + " kWh",
                                            justify="left", bd=-2)
        self.P1_L2_Pre_Mon_Data6.pack(side="top", anchor="w", expand=False)

        # Line3 previous month data
        self.P1_L3_Pre_Mon_Data_Frame = tk.Frame(self.P1_Data_Col4_Row2, height=self.P1_Table_Data_Row_Height,
                                                 width=int(200 - 120))
        self.P1_L3_Pre_Mon_Data_Frame.pack(side="top", anchor="n", expand=True)
        self.P1_L3_Pre_Mon_Data_Frame.pack_propagate(0)
        self.P1_L3_Pre_Mon_Data1 = tk.Label(self.P1_L3_Pre_Mon_Data_Frame, text="{: >4d}".format(0) + " kWh",
                                            justify="left", bd=-2)
        self.P1_L3_Pre_Mon_Data1.pack(side="top", anchor="w", expand=False)
        self.P1_L3_Pre_Mon_Data2 = tk.Label(self.P1_L3_Pre_Mon_Data_Frame, text="{: >4d}".format(0) + " kWh",
                                            justify="left", bd=-2)
        self.P1_L3_Pre_Mon_Data2.pack(side="top", anchor="w", expand=False)
        self.P1_L3_Pre_Mon_Data3 = tk.Label(self.P1_L3_Pre_Mon_Data_Frame, text="{: >4d}".format(0) + " kWh",
                                            justify="left", bd=-2)
        self.P1_L3_Pre_Mon_Data3.pack(side="top", anchor="w", expand=False)
        self.P1_L3_Pre_Mon_Data4 = tk.Label(self.P1_L3_Pre_Mon_Data_Frame, text="{: >4d}".format(0) + " kW",
                                            justify="left", bd=-2)
        self.P1_L3_Pre_Mon_Data4.pack(side="top", anchor="w", expand=False)
        self.P1_L3_Pre_Mon_Data5 = tk.Label(self.P1_L3_Pre_Mon_Data_Frame, text="{: >4d}".format(0) + " kVA",
                                            justify="left", bd=-2)
        self.P1_L3_Pre_Mon_Data5.pack(side="top", anchor="w", expand=False)
        self.P1_L3_Pre_Mon_Data6 = tk.Label(self.P1_L3_Pre_Mon_Data_Frame, text="{: >4d}".format(0) + " kWh",
                                            justify="left", bd=-2)
    ...
    def UpdateBillInfo(self):
        ...
        self.BillInstance.UpdateBillData()

        # 3phase data
        CurMon3PTData = self.BillInstance.getPhaseCurMon()
        PreMon3PTData = self.BillInstance.getPhasePrevMon()

        # Signle phase data
        CurMonL1Data = self.BillInstance.getLine1CurMon()
        CurMonL2Data = self.BillInstance.getLine2CurMon()
        CurMonL3Data = self.BillInstance.getLine3CurMon()
        PreMonL1Data = self.BillInstance.getLine1PrevMon()
        PreMonL2Data = self.BillInstance.getLine2PrevMon()
        PreMonL3Data = self.BillInstance.getLine3PrevMon()
...
class Page2(Page):
    ...
    def Page2View1(self):
        # Create frame
        self.P2V1_DspFrame = tk.Frame(self, height=PAGE_FRAME_HEIGHT, width=PAGE_FRAME_WIDTH, borderwidth=2,
                                      bg="dark grey")
        self.P2V1_DspFrame.pack(side="top", fill="both", expand=False)

        # Page title
        self.P2V1_Title_Frame = tk.Frame(self.P2V1_DspFrame, height=PAGE_HEADER_HEIGHT, bd=1, relief='solid',
                                         bg=PAGE_HEADIING_COLOUR)
        self.P2V1_Title_Frame.pack(side="top", fill="both", expand=False)
        self.P2V1_Title_Frame.pack_propagate(0)
        self.P2V1_Title = tk.Label(self.P2V1_Title_Frame, text="ENGINEERING SCREEN", justify="right", font=30,
                                   bg=PAGE_HEADIING_COLOUR)
        ...
        self.P2V1btn = tk.Button(self.P2V1_Title_Frame, height=PAGE_HEADER_HEIGHT, text="TOTAL VALUES",
                                 command=lambda: [self.P2V1_DspFrame.pack_forget(), self.P2V1_DspFrame.destroy(),
                                                  Page2.Page2View2(self)], bg=BUTTON_COLOUR)
        ...
        # Title frame
        self.P2V1_SPT_Titles_Container_Frame = tk.Frame(self.P2V1_DspFrame,
                                                        height=int(PAGE_FRAME_HEIGHT - PAGE_HEADER_HEIGHT),
        ...
        self.P2V1_SPT_Titles_Frame = tk.Frame(self.P2V1_SPT_Titles_Container_Frame,
                                              height=int(PAGE_FRAME_HEIGHT - PAGE_HEADER_HEIGHT - 20),
        ...
        self.P2_SPT_L1_Container_Frame0 = tk.Frame(self.P2V1_DspFrame,
                                                   height=int(PAGE_FRAME_HEIGHT - PAGE_HEADER_HEIGHT),
        ...
        self.P2_SPT_L2_Container_Frame0 = tk.Frame(self.P2V1_DspFrame,
                                                   height=int(PAGE_FRAME_HEIGHT - PAGE_HEADER_HEIGHT),
                                                   width=self.P2V1_Data_Width)
        self.P2_SPT_L2_Container_Frame0.pack(side="left", anchor="nw", expand=False)
        self.P2_SPT_L2_Container_Frame0.pack_propagate(0)
        self.P2_SPT_L3_Container_Frame0 = tk.Frame(self.P2V1_DspFrame,
                                                   height=int(PAGE_FRAME_HEIGHT - PAGE_HEADER_HEIGHT),
                                                   width=self.P2V1_Data_Width)
        ...
        self.Data_Headings = ["V", "I", "KW", "KVAR", "KVA", "PF", "V ANGLE", "I ANGLE", "V THD", "I THD", "I TDD",
                              "FREQ"]
        ...
        # Line1 titles
        self.P2V1_L1_Title_Frame = tk.Frame(self.P2_SPT_L1_Container_Frame0, height=20, width=self.P2V1_Data_Width,
                                            bd=1,
                                            relief='solid')
        ...
        self.P2_SPT_L1_Frame0 = tk.Frame(self.P2_SPT_L1_Container_Frame0,
                                         height=int(PAGE_FRAME_HEIGHT - PAGE_HEADER_HEIGHT - 20),
        ...
        self.P2_SPT_L2_Frame0 = tk.Frame(self.P2_SPT_L2_Container_Frame0,
                                         height=int(PAGE_FRAME_HEIGHT - PAGE_HEADER_HEIGHT - 20),
                                         width=self.P2V1_Data_Width, bd=1, relief='solid')
        ...
        self.P2_SPT_L3_Frame0 = tk.Frame(self.P2_SPT_L3_Container_Frame0,
                                         height=int(PAGE_FRAME_HEIGHT - PAGE_HEADER_HEIGHT - 20),
                                         width=self.P2V1_Data_Width, bd=1, relief='solid')
    ...
    def RealTimeMeasurementReading(self):
        ...
        if self.P2V1_L1_Data1.winfo_exists() and PAGE2_SHOWN:
    ...
    def Page2View2(self):
        # Create frame
        self.P2V2_DspFrame = tk.Frame(self, height=PAGE_FRAME_HEIGHT, width=PAGE_FRAME_WIDTH, borderwidth=2,
                                      bg="dark grey")
        self.P2V2_DspFrame.pack(side="top", fill="both", expand=False)

        # Page title
        self.P2V2_Title_Frame = tk.Frame(self.P2V2_DspFrame, height=PAGE_HEADER_HEIGHT, bd=1, relief='solid',
                                         bg=PAGE_HEADIING_COLOUR)
        ...
        self.P2btn2 = tk.Button(self.P2V2_Title_Frame, height=PAGE_HEADER_HEIGHT, text="SINGLE PHASE VALUES",
                                command=lambda: [self.P2V2_DspFrame.pack_forget(), self.P2V2_DspFrame.destroy(),
                                                 Page2.Page2View1(self)], bg=BUTTON_COLOUR)
        ...
        self.P2V2_Body_Header_Frame = tk.Frame(self.P2V2_Body_Frame, height=20, width=int(WINDOW_WIDTH), bd=1,
                                               relief='solid')
        ...
        # Label frame
        self.P2V2_Col1_Black_Frame = tk.Frame(self.P2V2_Body_Frame1,
                                              height=int(PAGE_FRAME_HEIGHT - PAGE_HEADER_HEIGHT - 30),
        ...
        self.P2V2_Container1_Frame = tk.Frame(self.P2V2_Col2_Frame,
                                              height=int(PAGE_FRAME_HEIGHT - PAGE_HEADER_HEIGHT - 30),
        ...
        # 123 frame
        self.P2V2_Col4_Blank_Frame = tk.Frame(self.P2V2_Body_Frame1,
                                              height=int(PAGE_FRAME_HEIGHT - PAGE_HEADER_HEIGHT - 30),
                                              width=int(WINDOW_WIDTH / 2 * (2 / 3)), bd=1, relief='solid')
        ...
        self.P2V2_Container2_Frame = tk.Frame(self.P2V2_Col3_Frame,
                                              height=int(PAGE_FRAME_HEIGHT - PAGE_HEADER_HEIGHT - 30),
                                              width=int(WINDOW_WIDTH / 2 * (1 / 3)))
    ...
    def RealTimeMeasurementReading1(self):
        if self.P2V2_Data1.winfo_exists() and PAGE2_SHOWN:
...
class Page3(Page):
    def __init__(self, *args, **kwargs):
        ...
        self.P3_DspFrame = tk.Frame(self, height=PAGE_FRAME_HEIGHT, width=PAGE_FRAME_WIDTH, borderwidth=2,
                                    bg="dark grey")
        self.P3_DspFrame.pack(side="top", fill="both", expand=False)
        self.P3_DspFrame.pack_propagate(0)

        # Page Title
        self.P3_Title_Frame = tk.Frame(self.P3_DspFrame, height=PAGE_HEADER_HEIGHT, bd=1, relief='solid',
                                       bg=PAGE_HEADIING_COLOUR)
        ...
        # Page sub frames
        self.P3_Btn_Frame = tk.Frame(self.P3_DspFrame, height=int(WINDOW_HEIGHT - 30 - 50),
                                     width=int(WINDOW_WIDTH * 0.15),
                                     bd=1, relief='solid')
        self.P3_Btn_Frame.pack(side="left", expand=False, anchor="nw")
        self.P3_Btn_Frame.pack_propagate(0)

        self.P3_Data_Frame = tk.Frame(self.P3_DspFrame, height=int(WINDOW_HEIGHT - 30 - 50),
                                      width=int(WINDOW_WIDTH * 0.85),
                                      bd=1, relief='solid')
        ...
        # Create table frame
        self.P3_Table_Frame = tk.Frame(self.P3_Data_Frame, height=30, width=int(WINDOW_WIDTH * 0.85), bd=1,
                                       relief='solid')
        ...
        self.P3btn2 = tk.Button(self.P3_Btn_Frame, height=2, width=int(WINDOW_WIDTH * 0.15 - 7 * 2), text="DATALOG 2",
                                command=lambda: [self.ReadDataLog(2)], bg=BUTTON_COLOUR)
        self.P3btn2.pack(side="top", anchor="n", fill="x", pady=(7, 7), padx=(7, 7))

        self.P3btn3 = tk.Button(self.P3_Btn_Frame, height=2, width=int(WINDOW_WIDTH * 0.15 - 7 * 2), text="DATALOG 3",
                                command=lambda: [self.ReadDataLog(3)], bg=BUTTON_COLOUR)
        ...
        self.P3btn5 = tk.Button(self.P3_Btn_Frame, height=2, width=int(WINDOW_WIDTH * 0.15 - 7 * 2), text="Pre PAGE ",
                                command=lambda: [Page3.PagePrevBtn(self)], bg=BUTTON_COLOUR)
        self.P3btn5.pack(side="top", anchor="n", fill="x", pady=(7, 7), padx=(7, 7))

        self.P3btn6 = tk.Button(self.P3_Btn_Frame, height=2, width=int(WINDOW_WIDTH * 0.15 - 7 * 2), text="Next PAGE ",
    ...
    def ReadDataLog(self, LogNo):
        ...
        if self.DataLoggerNo == 0:
            ...
            self.DspHeaderArray = ["#", "Time Stamp", "Total kW", "Peak kW", "Shoulder kW", "Off Peak kW", "Mx Dmd kW",
                                   "Mx Dmd kVA"]
...
class Page4(Page):
    def __init__(self, *args, **kwargs):
        ...
        self.P4_DspFrame = tk.Frame(self, height=PAGE_FRAME_HEIGHT, width=PAGE_FRAME_WIDTH, borderwidth=2,
                                    bg="dark grey")
        self.P4_DspFrame.pack(side="top", fill="both", expand=False)
        self.P4_DspFrame.pack_propagate(0)

        # Page title
        self.P4_Title_Frame = tk.Frame(self.P4_DspFrame, height=PAGE_HEADER_HEIGHT, bd=1, relief='solid',
                                       bg=PAGE_HEADIING_COLOUR)
        self.P4_Title_Frame.pack(side="top", fill="both", expand=False)
        self.P4_Title_Frame.pack_propagate(0)
        self.P4_Title = tk.Label(self.P4_Title_Frame, text="SETTINGS", justify="right", font=('', 12),
                                 bg=PAGE_HEADIING_COLOUR)
        ...
        self.Exitbtn = tk.Button(self.P4_Title_Frame, height=PAGE_HEADER_HEIGHT, width=10, text="EXIT",
                                 command=lambda value=self.NetworkConfig.CloseProgram: PasswordWindow.create(value),
                                 bg=BUTTON_COLOUR)
        ...
        self.P4_B1R2_Col1_Container = tk.Frame(self.P4_B1R2_Container, height=self.P4_Row2_Height,
                                               width=int(WINDOW_WIDTH / 4))
        ...
        self.P4_B2R1_Col1_Container = tk.Frame(self.P4_B2R1_Container, height=self.P4_Row1_Height,
                                               width=int(WINDOW_WIDTH / 4))
        ...
        self.P4_B2R2_Col1_Container = tk.Frame(self.P4_B2R2_Container, height=self.P4_Row1_Height,
                                               width=int(WINDOW_WIDTH / 4))
        ...
        self.ApplybtnHMI = tk.Button(self.P4_B2R1_Col2_Container, height=1, width=BUTTON_WIDTH, text="Apply",
                                     command=lambda value=self.OnClickSubmit1: PasswordWindow.create(value),
                                     bg=BUTTON_COLOUR)
    ...
    def __del__(self, *args, **kwargs):
        pass
        # print("Page4 being automatically destroyed. Goodbye!")
            ...
            for y, row in enumerate(self.alphabets):
                ...
                for text in row:
                    if text in ('Enter'):
                        ...
                        width = 9
                        padx = 0
                    tk.Button(self.window, text=text, width=width, height=2,
                              command=lambda value=text: self.select(self.entryBox, value)
                              , padx=padx, pady=1, bg=BUTTON_COLOUR, fg="black", font=(None, 9)).grid(row=y + 1,
                                                                                                      column=x,
...
class Authentication:
    ...
    def create(self, func):
        ...
        if not self.ExitWindowState:
            ...
            ExitLine1.pack(side="top", fill="both", expand=False, pady=(15, 5),
                           padx=(self.PaddingWindow, self.PaddingWindow))
            ExitLine2 = tk.Frame(self.ExitWindow, height=5)
            ExitLine2.pack(side="top", fill="both", expand=False, pady=(1, 0),
                           padx=(self.PaddingWindow, self.PaddingWindow))
            ExitLine3 = tk.Frame(self.ExitWindow, height=5)
            ExitLine3.pack(side="top", fill="both", expand=False, pady=(1, 0),
                           padx=(self.PaddingWindow, self.PaddingWindow))

            label = tk.Label(ExitLine1, text="Password :", justify="right")
            label.pack(side="left", fill="x", expand=False, anchor="nw")

            self.PwdTextbox = tk.Entry(ExitLine1, width=7, highlightbackground="gray40", bg="white", borderwidth=0,
                                       show="*")
            self.PwdTextbox.pack(side="left", fill="x", padx=(1, 1))
            self.PwdTextbox.bind("<ButtonRelease-1>",
                                 lambda event, arg=self.PwdTextbox: self.NumberpadWindow.create(arg))
            ...
            OkBtn = tk.Button(ExitLine2, height=1, width=5, text="Ok",
                              command=lambda value=func: self.OnClickOkBtn(value))
...
class MainView(tk.Frame):
    def __init__(self, *args, **kwargs):
        ...
        # Add buttons
        self.Menubtn1 = tk.Button(self.Headerframe, height=1, width=BUTTON_WIDTH, bg=BUTTON_COLOUR, text="BILLING",
                                  command=lambda: [self.DisplayPage(1)])
        self.Menubtn1.pack(side="left", anchor="nw", fill="y")
        self.Menubtn2 = tk.Button(self.Headerframe, height=1, width=BUTTON_WIDTH, bg=BUTTON_COLOUR, text="ENGINEERING",
                                  command=lambda: [self.DisplayPage(2)])
        self.Menubtn2.pack(side="left", anchor="nw", fill="y")
        self.Menubtn3 = tk.Button(self.Headerframe, height=1, width=BUTTON_WIDTH, bg=BUTTON_COLOUR, text="HISTORY",
                                  command=lambda: [self.DisplayPage(3)])
        self.Menubtn3.pack(side="left", anchor="nw", fill="y")
        self.Menubtn4 = tk.Button(self.Headerframe, height=1, width=BUTTON_WIDTH, bg=BUTTON_COLOUR, text="SETTINGS",
                                  command=lambda: [self.DisplayPage(4)])
        self.Menubtn4.pack(side="left", anchor="nw", fill="y")

        # Page title widget
        global PageTitle
        PageTitle = tk.Label(self.Headerframe, width=10, text=HMI_Library.METER_MODELNAME, justify="center",
                             font='-weight bold')
        ...
        self.Logo_File = self.Logo_File.resize(
            (int(self.Logo_Width / self.Logo_Height * 30), 30),
            Image.LANCZOS
        )
